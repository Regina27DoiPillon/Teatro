    ...
    public static void main(String[] args) {
        ...
        while (loopsala == true) {
            ...
            switch (sala) {
                ...
                case 1:
                    System.out.println("Título da peça: A Bela adormecida");
                    System.out.print("   ");
                    ...
                    while (i < 0 || i == 0) {
                        ...
                        for (i = qntdd_ingresso; i > 0; i--) {
                            ...
                            System.out.println("Informe qual assento na coluna deseja " + co_re + ":");
                            x = teclado.nextLine();
                            x = x.toLowerCase();
                            System.out.println("Informe qual assento na fileira deseja " + co_re + ":");
                            y = teclado.nextInt();
                            y = y - 1;
                ...
                default:
                    System.out.println("Informação digitada incorreta.");
            }
        }
    }
}